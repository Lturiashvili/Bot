...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not exists:
        ...
        text = (
            "გამარჯობა 🌟\n\n"
            "თუ გაინტერესებს ასტროლოგია, ტარო, ალქიმია, ტრანზიტების ანალიზი — ეს მხოლოდ მცირე ჩამონათვალია. ჩვენს დახურულ არხზე შენ გელოდება ცოდნა, რომელიც საჯაროდ არ ზიარდება. ექსკლუზიური ვიდეოები და ყოველდღიური პროგნოზები, რომლებიც შენს რეალობას შეცვლის 
,\n"
            "გამოიყენე /subscribe\n"
